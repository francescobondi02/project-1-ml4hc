...
def train_aggregator(pipeline, aggregator, df_timeseries, df_labels, variables, epochs=5, lr=1e-3,
                     device='cpu'):
...
def evaluate_aggregator(pipeline, aggregator, df_timeseries, df_labels, variables, device='cpu'):
    aggregator.eval()
    all_logits = []
    all_labels = []
